        ...
        <div class="row align-items-center">
          <div class="col-12">
            <div class="row align-items-center">
              ...
              @auth
              <p data-aos="fade-up" data-aos-delay="300"><a href="{{url('/admin')}}" class="btn btn-primary py-3 px-5 btn-pill">Dashboard</a></p>
             @else
             <p data-aos="fade-up" data-aos-delay="300"><a href="{{url('/admin/login')}}" class="btn btn-primary py-3 px-5 btn-pill">Login Now</a></p>
             @endauth
            </div>
